...
class Parameters:
    def __init__(self):
        ...
        self.cpuct              = 1.25               
        self.opening_train      = 20 # Increased for maximum exploration
        self.opening_test       = 0                  
        self.opening            = self.opening_train 
        self.Temp               = 1.0                
        self.dirichlet_alpha    = 0.3
        self.dirichlet_eps      = 0.5 # Increased noise to break bias
        ...
        self.epochs         = 10                      
        self.batch_size     = 128                     
        self.lam            = 0.002 # Re-heating LR to break plateau
